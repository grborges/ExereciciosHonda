...
int main(){
    ...
    printf("\n O valor mensal a separar para as férias do funcionário é %.2f.\n", ferias);

    //Décimo terceiro

    decter = salBA / 12;

    printf("\nO valor mensal a separar para o décimo terceiro sálario é %.2f.\n", decter);
    ...
    printf("\nO valor total da reserva mensal para esse funcionário é %.2f.\n", saliquido);
    ...
    if(demiresp == 1){
        ...
        dectertotal = salBA / 12 * mesestrab;
